...
- **creador de productos tecnológicos** — diseña, desarrolla e implementa

No es "un dueño de restaurante". DiMango es también su laboratorio operativo.

**Cómo trabaja:** detectar problema → entender causa → diseñar solución → probar → medir → corregir. Método propio, práctico, no heredado de ningún gurú.

**Herramientas de IA:** usa intensivamente ChatGPT, Claude y herramientas de desarrollo asistido.

## Las dos empresas

### DiMango — foco actual, 100% de la caja

Restaurante, cafetería, heladería y pizzería. Dos locales físicos en Arica:

- **DiMango Playa Chinchorro**
- **DiMango Mall Plaza Arica**

Modelo B2C presencial. Cliente: consumidor final — residentes de Arica y turistas.
Categorías: helados artesanales, pizzas, pastas, cafetería, sándwiches, platos preparados, repostería, bebidas.
Equipo: ~45 trabajadores (cocina, producción, heladería, garzones, caja, bodega, aseo, administración, supervisión).

### Aurexgroup — PARQUEADO hasta el 17 de noviembre de 2026

Empresa tecnológica. Soluciones digitales y de automatización para restaurantes y negocios de atención presencial: pedidos digitales, pedidos y pagos desde la mesa, autoservicio, tótems, impresión de comandas, fidelización, automatización operacional, IA aplicada.
...
Ver `SOUL.md`. Resumen: confrontación dura basada en datos, conclusión primero, sin relleno, una recomendación, nunca inventar, nunca dejarlo abrir proyectos sin cuestionarlo.

## Objetivo #1 — próximos 90 días (hasta el 17 de noviembre de 2026)

> **Reducir la dependencia operativa de DiMango respecto de Ricardo.**
> Meta declarada: que DiMango pueda funcionar 30 días sin que Ricardo sea necesario para resolver decisiones operacionales normales.

Componentes que él identificó: definir responsables · definir autoridad · identificar decisiones que escalan hacia él · crear procedimientos · indicadores visibles · automatizar tareas repetitivas · sistema de escalamiento real · desarrollar un segundo al mando.
